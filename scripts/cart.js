...
function submitOrder() {
    ...
    let message = `¡Hola La Esquina del Combinado! Quiero realizar el siguiente pedido:\n\n`;
    ...
    const whatsappUrl = `https://wa.me/51920352700?text=${encodeURIComponent(message)}`; /*AQUI EL NUMERO*/
